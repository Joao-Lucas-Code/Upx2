...
**[COLOQUE AQUI UMA FOTO BONITA DO PROTÓTIPO FINALIZADO]**
*(Exemplo: `![Protótipo Final](assets/foto_prototipo.jpg)`)*
...
**[COLOQUE AQUI O PRINT DO DIAGRAMA DO TINKERCAD OU FOTO DO CIRCUITO]**
*(Exemplo: `![Diagrama Elétrico](assets/diagrama_tinkercad.png)`)*
...
**[COLOQUE AQUI O PRINT DA TELA DO CELULAR COM O APP BLYNK]**
*(Exemplo: `![App Blynk](assets/print_blynk.jpg)`)*
